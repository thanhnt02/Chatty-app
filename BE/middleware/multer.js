...
const upload = multer({
  ...
  fileFilter: function (req, file, cb) {
    ...
    //   console.log("Chỉ cho upload file ảnh!")
...
const handleUpload = (req, res, next) => {
  return upload.array('files')(req, res, (error) => {
    ...
    // Do something with the file paths, such as saving them to a database or responding to the client
...
module.exports = { handleUpload , handleUploadSingle}